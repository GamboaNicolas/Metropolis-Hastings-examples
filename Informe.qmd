...
1. $\Sigma^* = \begin{bmatrix} 1 & 0 \\ 0 & 2 \end{bmatrix}$ Se puede ver en @fig-cov1 y @fig-trace-cov1

2. $\Sigma^* = \begin{bmatrix} 0.25 & 0 \\ 0 & 0.25 \end{bmatrix}$ Se puede ver en @fig-cov2 y @fig-trace-cov2

3. $\Sigma^* = \begin{bmatrix} 1 & 0.3 \\ 0.3 & 1 \end{bmatrix}$ Se puede ver en @fig-cov3 y @fig-trace-cov3
...
#| fig-cap: "Distribución de las muestras obtenidas por Metropolis-Hastings de una $\\mathcal{N}_2(\\mu^*, \ \\Sigma^*)$"
#| label: fig-cov1
...
#| fig-cap: "Cadena de Markov de las muestras obtenidas por Metropolis-Hastings de una $\\mathcal{N}_2(\\mu^*, \ \\Sigma^*)$"
...
```{r}
# i
mean(cadena1$muestra_mh$dim_1 > 1 & cadena1$muestra_mh$dim_2 < 0)

# ii
mean(cadena1$muestra_mh$dim_1 > 1 & cadena1$muestra_mh$dim_2 > 2)

# iii
mean(cadena1$muestra_mh$dim_1 > 0.4 & cadena1$muestra_mh$dim_2 > 0.75)
