...
```{r}
sample_mh <- function(n, d_objetivo, cov_propuesta = diag(2), p_inicial = numeric(2)) {
...
cadena <- sample_mh(n = 10000,d_objetivo = d_obj, cov_propuesta = cov_prop, p_inicial = c(0,0))
...
#| fig-cap: "Titulos"
#| fig-subcap: "lallala"
plot_hotmap(muestra = cadena, d_objetivo = d_obj, puntos = F)
